    ...
    <div className="flex w-full h-screen overflow-hidden bg-background max-lg:flex-col max-lg:h-auto max-lg:min-h-screen">
      ...
      >
        <div className="max-w-180">
          <h1 className="text-[26px] font-bold text-(--title-color) tracking-[-0.01em] mb-5">
            {title}
          </h1>
          <hr className="border-none border-t border-white/8 mb-8" />

          <div className="flex flex-col gap-10">{children}</div>

          <div className="flex justify-between items-center pt-8 pb-4 border-t border-white/8 mt-12">
            {prev && (
              <button
